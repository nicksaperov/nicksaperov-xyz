...
const INITIAL_PRODUCTS = [
  {
    ...
    name: "Фронт-филл A&S (212+Hi)",
    desc: "Два широкополосных 12″ динамика и центральный твиттер. Конструкция корпуса минимизирует паразитные отражения благодаря узкой вертикальной направленности.",
    specs: "2 х 12″ НЧ | 1.4″ ВЧ | 65 Гц — 20 кГц | 107 дБ/Вт/м",
    power: "700",
    dimensions: "900x375",
    price: "",
    img: "/front.jpg"
  },
  {
    ...
    category: "Сабвуферы",
    name: "Сабвуфер HST",
    desc: "Технология Hybrid Slot Transmission (HST) сочетает эффективность щелевого фазоинвертора и оптимизированную конструкцию воздушного канала для глубокого и насыщенного баса.",
    specs: "18″ НЧ | 26-400 Гц | 130 дБ SPL | 8 Ом",
    power: "1200",
    dimensions: "Custom",
    price: "",
    img: "/Sub1.jpeg"
  },
  {
    id: "sub-tl",
    category: "Сабвуферы",
    name: "Сабвуфер (Трансмиссионная линия)",
    desc: "Конструктивно выполнен в виде трансмиссионной линии в прямоугольном корпусе. Позволяет существенно расширить диапазон в область самых низких частот.",
    specs: "18″ НЧ | 26-400 Гц | 130 дБ SPL | 8 Ом",
    power: "1400",
    dimensions: "Custom",
    price: "",
  ...
  },
  {
    ...
    desc: "Cателлит активного разделения. Максимальный уровень звукового давления – 136 дБ. Защита драйверов — стальная решётка с порошковым покрытием.",
    specs: "15″ НЧ | 1″ ВЧ | 48-20000 кГц | 101 дБ/Вт/м",
    power: "1800",
    dimensions: "Custom",
    price: "",
    img: "/Sat1.jpeg"
  },
  {
    ...
    desc: "Резонатор Гельмгольца с 12-дюймовым широкополосным динамиком. Сепарация производится оптимизированным кроссовером со встроенной защитой драйвера.",
    specs: "12″ НЧ | 1″ ВЧ | 62-20000 Гц | 130 дБ SPL",
    power: "900",
    dimensions: "Custom",
    price: "",
    img: "/Mon1.jpeg"
  },
  {
    ...
    category: "Архитектурные",
    name: "Рупор A&S",
    desc: "Широкодиапазонный свёрнутый компрессионный рупор с мощным драйвером для высочайшей разборчивости. Легчайшая майларовая диафрагма.",
    specs: "2″ СЧ | 200 Гц — 7 кГц | 110 дБ/Вт/м | 16 Ом",
    power: "100",
    dimensions: "Custom",
    price: "",
    img: "/Rup1.jpeg"
