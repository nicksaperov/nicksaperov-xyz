...
function App() {
    ...
    const fetchGeminiWithRetry = async (text) => {
        // Fast-fail mock response to bypass the 15-second API timeout
    ...
    const handleSendMessage = async () => {
        ...
        // FORCED DIAGNOSTIC: Trigger email capture immediately on the FIRST message
        if (!leadCaptured) {
            setTimeout(() => {
    ...
    const handleSubmitLead = async () => {
        ...
        try {
            ...
            if (dbInstance) {
                ...
                // 1. EDGE-CRM TRIGGER: Fire unconditionally (Bypasses local auth locks)
                ...
                // 2. Legacy Write: Only fire if authentication succeeded
